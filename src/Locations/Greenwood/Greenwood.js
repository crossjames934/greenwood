...
import {faHome, faDrumstickBite, faBong, faBeer} from '@fortawesome/free-solid-svg-icons';
import {bindActionCreators} from 'redux';
import {setActiveComponent} from "../../Redux/actions/actions";
import SqualorSquare from "./SqualorSquare/SqualorSquare";
import CluckShack from "./CluckBunker/CluckBunker";
  ...
  render() {
    return(
      <div>
        ...
        <NavigationButton color="warning" icon={faDrumstickBite} text="Cluck Shack" targetComponent={<CluckShack/>}/>
